...
module.exports = function(router) {
    ...
    // Start Sendgrid Configuration Settings(Use only
    //     if using sendgrid)
    // var options = {
    //     auth: {
    //         api_user: 'jmosby', // Sendgrid username
    //         api_key: 'l1111111' // Sendgrid password
    //     }
    // };
    ...
    var client = nodemailer.createTransport({
        service: 'Zoho',
        auth: {
            user: 'mosbyj@zoho.com', // Your email address
            pass: 'Goodbye#1' // Your password
        },
        ...
        if (req.body.username === null || req.body.username === '' || req.body.password === null || req.body.password === '' || req.body.email === null || req.body.email === '' || req.body.name === null || req.body.name === '') {
            ...
            user.save(function(err) {
                if (err) {
                    ...
                    var email = {
                        from: 'Twitlife, mosbyj@zoho.com',
                        to: [user.email, 'mosbyj@zoho.com'],
                        subject: 'Your Activation Link',
                        text: 'Hello ' + user.name + ', thank you for registering at localhost.com. Please click on the following link to complete your activation: http://127.0.0.1:8080/activate/' + user.temporarytoken,
                        html: 'Hello<strong> ' + user.name + '</strong>,<br><br>Thank you for registering at localhost.com. Please click on the link below to complete your activation:<br><br><a href= "http://127.0.0.1:8080/activate/' + user.temporarytoken + '"> http://127.0.0.1:8080/activate/</a>'
                    };
                ...
                user.save(function(err) {
                    if (err) {
                        ...
                        var email = {
                            ...
                            text: 'Hello ' + user.name + ', You recently requested a new account activation link. Please click on the following link to complete your activation: http://127.0.0.1:8080/activate/' + user.temporarytoken,
                            html: 'Hello<strong> ' + user.name + '</strong>,<br><br>You recently requested a new account activation link. Please click on the link below to complete your activation:<br><br><a href="http://127.0.0.1:8080/activate/' + user.temporarytoken + '">http://127.0.0.1:8080/activate/</a>'
                        };
                    ...
                    user.save(function(err) {
                        if (err) {
                            ...
                            var email = {
                                ...
                                text: 'Hello ' + user.name + ', You recently request a password reset link. Please click on the link below to reset your password:<br><br><a href="http://127.0.0.1:8080/reset/' + user.resettoken,
                                html: 'Hello<strong> ' + user.name + '</strong>,<br><br>You recently request a password reset link. Please click on the link below to reset your password:<br><br><a href="http://127.0.0.1:8080/reset/' + user.resettoken + '">http://127.0.0.1:8080/reset/</a>'
                            };
                            // Function to send e-mail to the user
                            client.sendMail(email, function(err, info) {
                                if (err) {
